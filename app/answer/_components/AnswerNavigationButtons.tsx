      ...
      {/*
        <IconButton
          ...
          sx={{ 
            minWidth: 48,
            minHeight: 48,
            backgroundColor: (isFirstQuestion || isSubmitting) ? 'transparent' : '#f5f5f5',
            '&:hover': {
              backgroundColor: (isFirstQuestion || isSubmitting) ? 'transparent' : '#e0e0e0'
            },
            opacity: (isFirstQuestion || isSubmitting) ? 0.3 : 1
          }}
        >
          <ArrowBackIcon />
        </IconButton>
